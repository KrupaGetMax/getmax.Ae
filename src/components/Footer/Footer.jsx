...
import GetmaxLogo from "../../assets/getmaxWhite.png";
const Footer = () => {
  return (
    <>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <a
                    href="https://www.facebook.com/GetMax.Ae/"
                    target="_blank"
                  ...
                  <a
                    href="https://teams.microsoft.com/l/message/19:5029cd48-3738-4a68-abc2-355c5de8f49f_c1e75e89-af0b-41ab-8a7a-e25646c33b2e@unq.gbl.spaces/1714651240619?context=%7B%22contextType%22%3A%22chat%22%7D"
                    target="_blank"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
